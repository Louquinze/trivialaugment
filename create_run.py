...
classes = [cls_name for cls_name, cls_obj in
           ...
           if inspect.isclass(cls_obj) and "drnas" in cls_name]
...
for activation in classes:
    for k, conf in enumerate(
            [res18_cifar10, wres28_2_cifar10, res34_cifar10, wres40_2_cifar10, res50_cifar10, wres28_10_cifar10,
        ...
        for seed in range(10):
            ...
            with open(f"run_eval_{model}.txt", "a") as run:
                run.write(
